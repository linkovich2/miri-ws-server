...
var Miri = map[string]*core.Room{
	"1:0:1": &core.Room{
		...
		Entities:    []core.Entity{e.KraJaficMerchantCrowd.Copy(), e.KraJaficAmbiance.Copy(), e.KraJaficMerchantAmbiance.Copy()},
	},
	"0:1:1": &core.Room{
		...
		Size:        core.RoomLarge,
		Details:     []string{"trading tents", "bazaar", "sand", "traders"},
		Entities:    []core.Entity{e.KraJaficAmbiance.Copy(), e.KraJaficShadyMerchantCrowd.Copy()},
	},
	"1:1:1": &core.Room{
